    ...
    <!-- Start Banner 
    ============================================= -->
    <div class="banner-area top-pad-90 bg-mixed double-items text-light" style="background-image: url(assets/img/shape/23.png);">
        <div id="bootcarousel" class="carousel slide carousel-fade animate_text" data-ride="carousel">
            <!-- Wrapper for slides -->

            <div class="carousel-inner carausel">
                                ...
                                <div class="content">
                                    <div class="row align-center">
                                        <div class="col-lg-6 info">
                                            <h2 data-animation="animated slideInRight">We Serve All in One Stop Solutions</h2>
                                            ...
                                            <a class="kg-btn-animation border light" href="about-us.html"  data-animation="animated slideInUp">Get Started <i class="arrow_right"></i></a>
                                        </div>
                                        <div class="col-lg-6 thumb" data-animation="animated slideInLeft">
                                            <img src="assets/img/animate/it1.gif" class="cutom-round-1 sc-1" alt="Thumb">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-cell">
                            <div class="container">
                                <div class="content">
                                    <div class="row align-center">
                                        <div class="col-lg-6 info">
                                            <h2 data-animation="animated slideInDown">We Make Futuristic Smart City</h2>
                                            <p data-animation="animated slideInLeft">
                                                Arrived Size now easy eat hand how. Unwilling he departure elsewhere dejection at. Heart large seems may purse means few blind.
                                            </p>
                                            <a class="kg-btn-animation border light" href="about-us.html"  data-animation="animated slideInUp">Get Started <i class="arrow_right"></i></a>
                                        </div>
                                        <div class="col-lg-6 thumb" data-animation="animated slideInRight">
                                            <img src="assets/img/animate/sc1.gif" class="cutom-round-1 sc-1" alt="Thumb">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="features-box">
                <div class="row">
                    <div class="col-lg-12 featur-item">
                        <div class="row">
                            <!-- Single Itme -->
                            <div class="col-lg-3 col-md-6 single-item wow fadeInUp" data-wow-delay="100ms">
                                <div class="item">
                                    <div class="icon">
                                        <img src="assets/img/animate/proc.gif" class="an-gif" alt="">
                                    </div>
                                    <div class="content">
                                        <h4>Procurement</h4>
                                        <p>
                            ...
                            <!-- End Single Itme -->
                            <!-- Single Itme -->
                            <div class="col-lg-3 col-md-6 single-item wow fadeInUp" data-wow-delay="200ms">
                                <div class="item">
                                    <div class="icon">
                                    <img src="assets/img/animate/light.gif" class="an-gif" alt="">
                                    </div>
                                    <div class="content">
                                        <h4>EK & SPINNER TECH</h4>
                                        <p>
                                            EK Technology is a LEARN, TEACH, IMPLEMENT Center and Spinner Tech is a Innovation, Science, Lab-Test, Production, Maintenance
                                        </p>
                                        <a href="#"><i class="arrow_right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-6 single-item wow fadeInUp" data-wow-delay="300ms">
                                <div class="item">
                                    ...
                                    <div class="content">
                                        <h4>EK Architect</h4>
                                        <p>
                                        EK Architect - architectural design studio, flourished out as a Global Brand in the world of architectural modeling services. 
                                        </p>
                                        <a href="#"><i class="arrow_right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-6 single-item wow fadeInUp" data-wow-delay="400ms">
                                <div class="item">
                                    ...
                                    <div class="content">
                                        <h4>Education</h4>
                                        <p>
                                            Cousin no itself eldest in dinner Boisterous estimating is interested collecting get conviction. 
                                        </p>
                                        <a href="#"><i class="arrow_right"></i></a>
                                    </div>
                                </div>
    ...
    <!-- Start Free Trial 
    ============================================= -->
    <div class="free-trial-area overflow-hidden relative bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 left-info">
                    <h2>10 <span>Best Software</span></h2>
                    <p>
                    Every installation of Windows 10 includes a huge collection of the built-in app. However, there are many useful apps that you could have on your PC to perform additional tasks. Such app help you to clear malware, listen to music, to play games, to perform simple drawing, watch movies, communications, and performing various functions.
                    ...
                    <a class="btn circle kg-btn-theme effect kg-btn-sm" href="#">Get Free Trial</a>
                </div>
                <div class="col-lg-6 thumb wow fadeInUp">
                    <img src="assets/img/animate/solution.gif" alt="Thumb" style="margin-top:-2rem;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="choose-us-area relative">
        <div class="container-fluid">
            ...
            <img src="assets/img/animate/sc2.gif" class="w-100 h-100" alt="">
            </div>
                <div class="col-lg-6 info">
                    <h5>Statistics</h5>
                    ...
                    <div class="statistics">
                        <div class="item">
                            <div class="chart" data-percent="65" data-track-color="#888888" data-bar-color="#4628ba"><span>45%</span></div>
                            <h5>Normal City</h5>
                        </div>
                        <div class="item">
                            <div class="chart" data-percent="85" data-track-color="#888888" data-bar-color="#4628ba"><span>95%</span></div>
                            <h5>Smart City</h5>
                        </div>
                    </div>
                </div>
    ...
    <!-- Star Services
    ============================================= -->
    <div class="services-content-area text-center carousel-shadow bg-gray default-padding d-none">
        <!-- Fixed Shape -->
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="heading-center text-center">
                        ...
                        <h2>We create & design award <br>winning Digital products</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="services-content-box services-stage-carousel owl-carousel owl-theme">
                ...
                <div class="item">
                    ...
                    <p>
                        Suspected he remainder rapturous my sweetness. All vanity regard sudden nor simple can. World mrs and vexed china since after often. 
                    </p>
    ...
    <!-- Star Team
    ============================================= -->
    <div class="team-area default-padding-bottom bottom-less bg-gray ">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="heading-center text-center">
                        <h2 class="py-4">Meet our professional and expert team members</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="team-items text-center">
                <div class="row">
                    <!-- Single Item -->
                    <div class="single-item col-lg-4 col-md- wow fadeInUp" data-wow-delay="200ms">
                        <div class="item">
                            <div class="thumb">
    ...
    <!-- Start Pricing Area
    ============================================= -->
    <div class="pricing-area default-padding-bottom d-none">
        <!-- Fixed Shape -->
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="pricing-item">
                            ...
                            <div class="pricing-footer">
                                <a class="btn circle kg-btn-dark border kg-btn-sm" href="contact.html">Buy This Plan</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="pricing-item active">
                            ...
                            <div class="pricing-footer">
                                <a class="btn circle kg-btn-theme effect kg-btn-sm" href="contact.html">Buy This Plan</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 single-item">
    ...
    <!-- Star Blog
    ============================================= -->
    <div class="blog-area full-blog default-padding bottom-less d-none">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="heading-center text-center">
            ...
            <div class="blog-items">
                <div class="row">
                    ...
                    <!-- End Single Item -->
                     <!-- Single Item -->
                    <div class="col-lg-4 col-md-6 single-item wow fadeInUp" data-wow-delay="200ms">
                        <div class="item">
                            <div class="thumb">
                    ...
                    <!-- End Single Item -->
                     <!-- Single Item -->
                    <div class="col-lg-4 col-md-6 single-item wow fadeInUp" data-wow-delay="300ms">
                        <div class="item">
                            <div class="thumb">
                            ...
                            <div class="info">
                                <h4>
                                    <a href="blog-single-with-sidebar.html">Prevailed remainder may propriety can and. </a>
                                </h4>
                                <div class="footer-meta">
                                   <ul>
                                       <li>
